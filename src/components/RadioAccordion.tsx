          ...
          <AccordionPrimitive.Item key={header} value={header}>
            <AccordionPrimitive.Header>
              <AccordionPrimitive.Trigger asChild>
                <div className="group radix-state-open:rounded-t radix-state-closed:rounded flex w-full justify-between bg-white px-4 py-3 border-2 border-line cursor-pointer">
