...
export default function Welcome() {
  ...
  return (
    <MainTemplate title="Welcome!">
      ...
      <div className="h-56 my-2.5 py-5 bg-secondary overflow-y-scroll">
        <ol className="px-10 list-decimal">
          <li>
            ...
            {SERVICE_NAME} are for convenience and demonstration purposes only.
          </li>
          <li>
            ...
            damages, or losses that may arise from the use or reliance on models
            trained through our service.
          </li>
          <li>
            ...
            must adhere to the licensing stipulations set forth by the original
            copyright holders.
          </li>
        </ol>
      ...
      <p className="text-sm mb-6">
        By proceeding with the use of {SERVICE_NAME}, you signify your agreement
